...
def main():
    ...
    kp_instance = KeyProtect(iam_token, "4e40a26c-3243-4dd7-b844-1521e5109b12");
    #print(kp_instance.listKeys())

    # Defining key id
    crk_id = "39a42ac5-02d9-4ff1-b93b-d73151214349"
    ...
    # Define value to encrypt
    credit_card = "5452162517899084"

    # Encrypt value with wrapped dek and the crk_id
    encrypted_credit_card = kp_instance.encrypt(credit_card, wdek, crk_id)

    # Decrypt encrypted credit card data
    decrypted_credit_card = kp_instance.decrypt(encrypted_credit_card, wdek, crk_id)
    app.logger.info(decrypted_credit_card.decode("utf-8"))
