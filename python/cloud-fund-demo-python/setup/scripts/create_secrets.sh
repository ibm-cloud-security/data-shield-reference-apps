...
export API_KEY=$(echo -n $RAW_API_KEY | base64)
export APP_ID_CONFIG=$(echo -n $RAW_APP_ID_CONFIG | base64)
#export REACT_APP_bff_url=$(echo -n $app_REACT_APP_bff_url | base64)
#export REACT_APP_app_id_sign_in=$(echo -n $app_REACT_APP_app_id_sign_in | base64)
